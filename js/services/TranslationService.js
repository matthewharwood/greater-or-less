const translations = {
    ...
    hi: {
        ...
        winMessages: [
            ...
            "⭐ अद्भुत! आप सही हैं! ⭐",
            "🏆 चैंपियन! शाबाश! 🏆",
            "🎯 परफेक्ट शॉट! आपने कर दिखाया! 🎯",
            "🌟 शानदार! बेहतरीन काम! 🌟",
            "🚀 कमाल! आप आग हैं! 🚀",
            "💎 उत्कृष्ट! बहुत होशियार! 💎",
            "🎊 हुर्रे! शानदार! 🎊",
            "🥳 अविश्वसनीय! आपने कमाल कर दिया! 🥳",
            "🏅 असाधारण! बहुत बढ़िया! 🏅",
            "⚡ शानदार! अच्छा खेले! ⚡",
            "🎈 फैंटास्टिक! आप सितारे हैं! 🎈"
        ],
        // Encouragement messages
        encouragementMessages: [
            "🤔 अगली बार और सावधानी से सोचें!",
            "⏰ संख्याओं की तुलना करने के लिए अपना समय लें!",
            "👀 चुनने से पहले हर संख्या को ध्यान से देखें!",
            "📏 याद रखें: बड़ी संख्याएं छोटी संख्याओं से बड़ी होती हैं!",
            "🐌 जल्दबाजी न करें - इसे अच्छी तरह सोचें!",
            "🧠 इसे हल करने के लिए अपने दिमाग का उपयोग करें!",
            "👣 संख्याओं की तुलना कदम दर कदम करें!",
            "🚦 धीरे चलें और सोचें कौन सी बड़ी है!",
            "💪 अभ्यास से परफेक्ट बनता है - कोशिश करते रहें!",
            "🎯 क्लिक करने से पहले संख्याओं पर ध्यान दें!",
            "😮‍💨 गहरी सांस लें और सावधानी से सोचें!",
            "⭐ आप बेहतर कर सकते हैं - ज्यादा ध्यान दें!"
        ],
        // Tooltip messages
        tooltipGreater: "डॉट्स देखें! अगर 🔴 लाल दाईं ओर है, तो वह बड़ा है!",
        tooltipLess: "डॉट्स देखें! अगर 🔴 लाल बाईं ओर है, तो वह छोटा है!",
        // Explanation text
        isBigger: 'इससे बड़ा है',
        isSmaller: 'इससे छोटा है',
        areSame: 'और',
        areEqual: 'बराबर हैं',
        soStatement: 'इसलिए',
        isTrue: 'सही है',
        isFalse: 'गलत है',
        theyAreEqual: '(वे बराबर हैं)',
        biggerThan: 'से बड़ा',
        smallerThan: 'से छोटा',
        // Celebration messages
        incredible: 'अविश्वसनीय!',
        youCrushedIt: 'आपने कमाल कर दिया',
        streakLegend: '10 स्ट्रीक लीजेंड',
        champion: 'चैंपियन'
    }
};
